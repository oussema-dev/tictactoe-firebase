...
class Login : AppCompatActivity() {
    ...
    private var database=FirebaseDatabase.getInstance()//Realtime Database
    ...
    fun  SplitString(str:String):String{
        var split=str.split("@")//when it encounters @ it splits
        return split[0]//return the first half of the split
    }
}